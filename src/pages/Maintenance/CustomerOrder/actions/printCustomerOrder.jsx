...
const printCustomerOrder = (props) => {
    ...
    const generatePDF = async (id) => {
        ...
        try {
            ...
            const imgWidth = 65; // Ancho de la imagen
            const imgHeight = 20; // Alto de la imagen
            const x = 10; // Coordenada X de la esquina superior izquierda de la imagen
            const y = 10; // Coordenada Y de la esquina superior izquierda de la imagen
