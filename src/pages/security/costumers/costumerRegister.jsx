...
const costumerRegister = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      const cedulaAvailability = await checkCedula(
      ...
      if (
        ...
        if (cedulaAvailability == false) {
          swal(
            "Cédula se encuentra registrada",
        ...
        if (emailAvailability == false) {
          swal(
            "Correo electrónico se encuentra registrada",
        ...
        if (validPasswordFormat == false) {
          swal(
            "Contraseña invalida!",
            "La contraseña deseada, no es valida, debe contener mínimo 8 caracteres de longitud.",
            "warning"
          );
        }
      }
        ...
        <Row xs={12} lg={12} className="rowCard">
          <Card.Body>
              ...
              <Row>
                ...
                <Col xs={6} md={6} lg={6}>
                  <Form.Group controlId="validationCustom08">
                    <Form.Label className="labelLogin">
                      <Form.Label>Cuneta IBAN</Form.Label>
                    </Form.Label>
                    <Form.Control
                      type="number"
            ...
            <Col className="btnContainer text-center">
              <Button className="BtnStar" onClick={handleSubmit}>
                Enviar
              </Button>
            </Col>
          </Card.Body>
