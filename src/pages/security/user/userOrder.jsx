            ...
            <div className="card-body">
              <Row className="mb-3">
                <Col>
                  ...
                  {customerorderRequest.confirmedDate === "0001-01-01T00:00:00"
                    ? "Sin pagar"
                    : format(
                        new Date(customerorderRequest.confirmedDate),
                        "yyyy-MM-dd"
                      )}
                </Col>
                <Col>
                  ...
                  {customerorderRequest.paidDate === "0001-01-01T00:00:00"
                    ? "Sin pagar"
                    : format(
                        new Date(customerorderRequest.paidDate),
                        "yyyy-MM-dd"
                      )}
                </Col>
                <Col>
                  ...
                  {customerorderRequest.deliveredDate === "0001-01-01T00:00:00"
                    ? "Sin entregar"
                    : format(
                        new Date(customerorderRequest.deliveredDate),
                        "yyyy-MM-dd"
                      )}
                </Col>
              </Row>
                ...
                <tbody>
                  {MyOrders.map((order, index) => (
                    <tr key={index}>
                      ...
                      <td>{order.IVA * 100}%</td>
                      <td>
                        {order.Total == 0 ? "Por cotizar" : "₡" + order.Total}
                      </td>
                    </tr>
                  ))}
                </tbody>
              ...
              <div className="card">
                <div className="card-body row">
                  ...
                  <Col>
                    {customerorderRequest.total == 0
                      ? "Por cotizar"
                      : "₡" + customerorderRequest.total}
                  </Col>
                </div>
              </div>
            </div>
